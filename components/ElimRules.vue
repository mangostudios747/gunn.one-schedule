...
export default {
  name: "ElimRules",
  render(){
    return (<div class="prose-sm prose !text-white  max-w-none prose-invert">
        <ol >
          ...
          <li>You are still safe if you exit the class (e.g. going to the bathroom)</li>
          <li>You are not safe during a prep period</li>
          <li>You can tag in a classroom before or after class</li>
          <li>If a teacher wants absolutely no elimination in their classroom you must obey their wish. Teachers can report students, and you will be disqualified. </li>
          ...
          <li>You cannot be eliminated while performing school-related after-school activities (i.e. theater, GRT etc.). If you leave to go to the bathroom, etc. you are still safe</li>
          <li>This also includes a school dance</li>
          <li>You cannot be eliminated while participating in any extracurricular activities (including rehearsals, performances, classes, competitions, or practices). You are safe until the venue is entirely over. You can be tagged before the extracurricular starts or after it ends. </li>
          <li>You are safe when you are working (if you have a part-time job)</li>
          <li>You can be eliminated during a lunchtime club. </li>
          <li>Any participants and performers in a lunchtime rally are safe for the entire duration of the rally.</li>
          <li>If you are in the audience, you can be eliminated at the rally.</li>
          <li>You cannot throw the plushie in order to tag someone; you must tap the other person lightly</li>
          <li>You cannot own more than one plushie</li>
          <li>You cannot be eliminated while you are taking any type of school related assessments</li>
          <li>You cannot steal each other’s plushie</li>
          <li>You are not allowed to be tagged after having the plushie taken from you by force. If you have given the plushie to someone else by choice, you can be tagged</li>
          <li>You can get eliminated after school and on the weekends</li>
          <li>After you eliminate someone, enter the target’s pin number into the site to receive your next target</li>
          <li>You cannot tie the plushie to your hand or attach anything to the plushie</li>
          <li>Rules will change and become more intense over the course of the game</li>
          <li>NO BREAKING THE LAW</li>
          <li>AS OF MIDNIGHT 03/01/2022 - Players must hold the plushie and the game begins!</li>
        </ol>
