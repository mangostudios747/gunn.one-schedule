<template>
  <div class="mt-10">
    <div class="flex flex-col mx-auto max-w-md lg:max-w-4xl px-5 md:landscape:max-w-4xl
    lg:landscape:max-w-7xl landscape:max-w-2xl md:max-w-2xl md:flex-row-reverse 
    xl:max-w-9xl
    landscape:flex-row-reverse">
      ...
      <div class="md:mt-0 md:mr-10 landscape:mr-10 landscape:mt-0 h-full flex ">
        ...
        <ul>
          ...
          <li>Automatically generated todo list</li>
          <li>Schoology messaging</li>
          <li>Blazing fast, clean interface</li>
        </ul>
        </div>
      </div>
    </div>
