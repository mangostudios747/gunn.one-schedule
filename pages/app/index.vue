<template>
  <div class="flex flex-col mt-5 w-full">
    ...
    >
    <div :style="`background-color:${period.color[500] || period.color}; width:${period.progress}%;`" class="h-full transition-all duration-500 absolute left-0 rounded-md top-0 z-10">
    </div>
...
<style>
.class-block {
  @apply mx-auto relative shadow-xl w-[70%] my-2 backdrop-blur-sm py-4 px-6 rounded-md;
}
