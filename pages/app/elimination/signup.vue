<template>
  <form class="box flex flex-col gap-2 mx-auto my-auto text-white py-4 px-4 w-full ">
    <h1 class="text-lg font-bold block mx-auto">Sign up to play <span class="text-elimination">Elimination</span></h1>
    ...
    <input v-model="email" placeholder="PAUSD email" class="box-input" />
    <input v-model="password" placeholder="Password" type="password" class="box-input" />
    <input v-model="password2" placeholder="Confirm password" type="password" class="box-input" />
    <button type="submit" @submit.prevent="signup" class="btn-elimination">Sign Up</button>
