<template>
...
</svg> {{$store.getters['catalog/totalHW']}} minutes hw / week</div>
    ...
    >
      ...
      >
        <div class="big-icon flex">
          <div v-if="courses[key].subject.a"
            class="
              w-8
              h-8
              my-auto
          ...
          <div v-else-if="courses[key].subject.b"
            class="
              w-8
              h-8
              my-auto
          ...
          <div v-else-if="courses[key].subject.c"
            class="
              w-8
              h-8
              my-auto
          ...
          <div v-else-if="courses[key].subject.d"
            class="
              w-8
              h-8
              my-auto
          ...
          <div v-else-if="courses[key].subject.e"
            class="
              w-8
              h-8
              my-auto
          ...
          <div v-else-if="courses[key].subject.cte"
            class="
              w-8
              h-8
              my-auto
  ...
  <path fill-rule="evenodd" d="M7 2a1 1 0 012 0v1h2V2a1 1 0 112 0v1h2a2 2 0 012 2v2h1a1 1 0 110 2h-1v2h1a1 1 0 110 2h-1v2a2 2 0 01-2 2h-2v1a1 1 0 11-2 0v-1H9v1a1 1 0 11-2 0v-1H5a2 2 0 01-2-2v-2H2a1 1 0 110-2h1V9H2a1 1 0 010-2h1V5a2 2 0 012-2h2V2zM5 5h10v10H5V5z" clip-rule="evenodd" />
          ...
          <div v-else-if="courses[key].subject.vpa"
            class="
              w-8
              h-8
              my-auto
          ...
          <div v-else-if="courses[key].subject.pe"
            class="
              w-8
              h-8
              my-auto
  ...
  <path fill-rule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clip-rule="evenodd" />
        ...
        <div @click="$store.commit('catalog/setSelectedCourse', key)" class="info grow-0 flex flex-col">
          ...
          >
          <p v-if="courses[key].body" class="line-clamp-2 text-xs leading-4">{{ courses[key].body.description }}</p>
        </div>
        <div
          v-if="courses[key].length==='Semester'"
